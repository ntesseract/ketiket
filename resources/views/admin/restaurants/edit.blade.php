...
<div class="max-w-4xl mx-auto opacity-0" id="main-content">
    <div class="bg-white shadow-md rounded-lg overflow-hidden hover-scale">
        <div class="p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 slide-up">Edit Restoran: {{ $restaurant->name }}</h2>
            
            <form action="{{ route('admin.restaurants.update', $restaurant) }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="edit-form">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2 opacity-0" data-animate="fade-in" data-delay="100">
                        ...
                        <textarea name="description" id="description" rows="5"
                            ...
                            placeholder="Deskripsikan restoran ini">{{ old('description', $restaurant->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="opacity-0" data-animate="fade-in" data-delay="200">
                        ...
                        <input type="text" name="cuisine_type" id="cuisine_type" value="{{ old('cuisine_type', $restaurant->cuisine_type) }}"
                    ...
                    <div class="opacity-0" data-animate="fade-in" data-delay="200">
                        ...
                        <div class="mt-2">
                            <div class="flex items-center">
                                <input id="has_vegetarian_options" name="has_vegetarian_options" type="checkbox" value="1" {{ old('has_vegetarian_options', $restaurant->has_vegetarian_options) ? 'checked' : '' }}
                    ...
                    <div class="col-span-1 md:col-span-2 opacity-0" data-animate="fade-in" data-delay="300">
                        ...
                        <input type="text" name="location" id="location" value="{{ old('location', $restaurant->location) }}" required
                    ...
                    <div class="opacity-0" data-animate="fade-in" data-delay="600">
                        ...
                        <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number', $restaurant->contact_number) }}"
                    ...
                    <div class="opacity-0" data-animate="fade-in" data-delay="600">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="active" {{ (old('status', $restaurant->status) == 'active') ? 'selected' : '' }}>Aktif</option>
                            <option value="inactive" {{ (old('status', $restaurant->status) == 'inactive') ? 'selected' : '' }}>Tidak Aktif</option>
                    ...
                    <div class="opacity-0" data-animate="fade-in" data-delay="700">
                        ...
                        <input type="time" name="opening_hour" id="opening_hour" value="{{ old('opening_hour', $restaurant->opening_hour) }}"
                    ...
                    <div class="opacity-0" data-animate="fade-in" data-delay="700">
                        ...
                        <input type="time" name="closing_hour" id="closing_hour" value="{{ old('closing_hour', $restaurant->closing_hour) }}"
                    ...
                    <div class="col-span-1 md:col-span-2 opacity-0" data-animate="fade-in" data-delay="800">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md relative" 
                             x-data="{ 
                                fileName: '', 
                                previewUrl: '{{ $restaurant->image_path ? Storage::url($restaurant->image_path) : null }}',
                                currentImage: '{{ $restaurant->image_path ? true : false }}',
                                updatePreview(event) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const lat = parseFloat(latInput.value) || -2.5489; // Indonesia center
    const lng = parseFloat(lngInput.value) || 118.0149;
    
    const map = L.map('map').setView([lat, lng], lat !== -2.5489 ? 15 : 5);
