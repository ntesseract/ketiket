...
<div class="max-w-4xl mx-auto opacity-0" id="main-content">
    <div class="bg-white shadow-md rounded-lg overflow-hidden hover-scale">
        <div class="p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 slide-in">Tambah Destinasi Baru</h2>
            
            <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="create-form">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2 opacity-0" data-animate="fade-in" data-delay="100">
                        ...
                        <textarea name="description" id="description" rows="5" required
                            ...
                            placeholder="Deskripsikan destinasi ini">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <!-- Lokasi -->
                    <div class="col-span-1 md:col-span-2 opacity-0" data-animate="fade-in" data-delay="200">
                    ...
                    <div class="col-span-1 md:col-span-2 opacity-0" data-animate="fade-in" data-delay="300">
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <p class="mt-2 text-xs text-gray-500">
                                ...
                                Klik pada peta untuk menentukan lokasi atau masukkan nilai koordinat secara manual
                            </p>
                        </div>
                    </div>
...
<div class="mt-6 rounded-lg overflow-hidden shadow-lg opacity-0" data-animate="fade-in" data-delay="1000">
    <div class="parallax p-8 flex items-center justify-center" style="background-image: url('{{ asset('images/parallax-bg.jpg') }}'); height: 200px;">
        <div class="text-center bg-white bg-opacity-80 p-4 rounded-lg">
            ...
            <p class="text-gray-600">Tambahkan destinasi baru untuk memberikan pengalaman terbaik kepada wisatawan</p>
        </div>
    </div>
</div>
</div>
...
document.getElementById('create-form').addEventListener('submit', function(e) {
    ...
    if (!hasError) {
        ...
        // Will trigger when form is actually submitted
        confetti({
            particleCount: 100,
            spread: 70,
            origin: { y: 0.6 }
