...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Paket Wisata</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="5" required
                            ...
                            placeholder="Deskripsikan paket wisata ini">{{ old('description', $package->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_days" id="duration_days" value="{{ old('duration_days', $package->duration_days) }}" required min="1" max="30"
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="price" id="price" value="{{ old('price', $package->price) }}" required
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="border border-gray-300 rounded-md p-2 max-h-60 overflow-y-auto">
                            @php
                                $selectedHotels = old('hotels', $package->hotels->pluck('id')->toArray());
                            @endphp
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="border border-gray-300 rounded-md p-2 max-h-60 overflow-y-auto">
                            @php
                                $selectedRestaurants = old('restaurants', $package->restaurants->pluck('id')->toArray());
                            @endphp
                            ...
                            @foreach($restaurants as $restaurant)
                                <div class="p-2 hover:bg-gray-50 rounded-md flex items-start">
                                    <input type="checkbox" name="restaurants[]" value="{{ $restaurant->id }}" id="restaurant-{{ $restaurant->id }}"
                                        class="rounded border-gray-300 text-indigo-600 mt-1 focus:ring-indigo-500 h-4 w-4"
                                        {{ in_array($restaurant->id, $selectedRestaurants) ? 'checked' : '' }}>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md relative" 
                             x-data="{ 
                                fileName: '', 
                                previewUrl: '{{ $package->image ? Storage::url($package->image) : null }}',
                                updatePreview(event) {
